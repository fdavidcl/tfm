...
\documentclass[xetex,usenames,dvipsnames]{beamer}
...
\setmainfont{Crimson} % Free alternative to Minion Pro
\setsansfont{Lato}
\setmonofont{Source Code Pro}
\newfontfamily\myserif{Crimson}

% Paleta de colores
%\definecolor{accent}{RGB}{151, 186, 88}
\definecolor{accent}{RGB}{108, 171, 206}
...
\newcommand{\header}[1]{\textbf{\alert{#1}}}
